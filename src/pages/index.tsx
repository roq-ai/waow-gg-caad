  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Waow.GG - Your ultimate destination for exciting game matches and secure betting. Experience the thrill, test your skills, and make your bet count!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Waow.GG - Your ultimate destination for exciting game matches and secure betting. Experience the thrill, test your skills, and make your bet count!`}
            </Text>
            <Box
