...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['administrator'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_made.create': { roles: ['administrator'], key: 'payment_id', tenantPath: [], userPath: [] },
  'support_ticket_created.create': { roles: ['administrator'], key: 'ticket_id', tenantPath: [], userPath: [] },
};
